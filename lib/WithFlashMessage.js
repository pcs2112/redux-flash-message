...
var _FlashMessageTemplate = require('./FlashMessageTemplate');

var _FlashMessageTemplate2 = _interopRequireDefault(_FlashMessageTemplate);
...
var withFlashMessage = function withFlashMessage() {
  var WrappedComponent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _FlashMessageTemplate2.default;
...
exports.default = withFlashMessage;
